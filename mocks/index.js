...
const courses = [
  {
    ...
    url: 'http://topbreyns.uz/courses/1',
  },
  {
    id: 2,
    ...
    url: 'http://topbreyns.uz/courses/2',
  },
]
...
app.get('/home-faq', (req, res) => {
  const homefaq = [
    {
      id: 1,
      title: 'Что такое TopBreyns?',
      description:
        'TopBreyns – это платформа с онлайн обучением по курсам от одних из лучших специолистов в своей сфере. TopBreyns сама снимает курсы и имеет свою команду монтажеров, таким образом мы гарантируем вам высокий уровень видео уроков и приятный и постепенный процесс обучения от наших менторов. ',
    },
